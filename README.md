# Awesome Hyperledger Fabric with stars
...
[Supply chain](https://github.com/ialberquilla/hlf1.4-supply-chain) ⭐ 46 | 🐛 14 | 🌐 JavaScript | 📅 2022-12-11 - Supply chain PoC App with four organizations exposing a Rest API created in Hyperledger Fabric.
...
* [Fabric samples](https://github.com/hyperledger/fabric-samples) ⭐ 3,017 | 🐛 76 | 🌐 Go | 📅 2026-08-24 - Official maintained samples created by the Hyperledger team and contributors.
* [Marbles](https://github.com/IBM-Blockchain/marbles) ⭐ 1,025 | 🐛 23 | 🌐 JavaScript | 📅 2019-03-28 - Marbles sample created by IBM visually demonstrating all the possibilities.
...
* [Backend typescript boilerplate](https://github.com/wearetheledger/hyperledger-typescript-boilerplate) ⭐ 114 | 🐛 31 | 🌐 TypeScript | 📅 2023-01-23 - Client boilerplate for interacting with the Fabric network using a REST API (Typescript, Nestjs, swagger, pusher).
...
* [fabric-node-chaincode-utils](https://github.com/wearetheledger/fabric-node-chaincode-utils) ⚠️ Archived - A Nodejs module that helps you build your Hyperledger Fabric nodejs chaincode faster and easier.
* [hlf-sdk-go](https://github.com/s7techlab/hlf-sdk-go) ⭐ 43 | 🐛 3 | 🌐 Go | 📅 2025-11-13 - A third-party Golang Hyperledger Fabric SDK.
* [hyperledger-fabric-client-utils](https://github.com/Kunstmaan/hyperledger-fabric-client-utils) ⭐ 18 | 🐛 6 | 🌐 JavaScript | 📅 2019-01-23 - Set of utility functions which can be used to interact with chaincode.

### Network

* [hyperledger-fabric-network-setup](https://github.com/Kunstmaan/hyperledger-fabric-network-setup) ⭐ 31 | 🐛 9 | 🌐 Python | 📅 2018-06-19 - Helper functions for generating configurations for more advanced network setup.
...
* [CCKit](https://github.com/s7techlab/cckit) ⚠️ Archived - Library for creating and testing golang chaincode, includes extended Mockstub implementation.
* [fabric-mock-stub](https://github.com/wearetheledger/fabric-mock-stub) ⚠️ Archived - Mock implementation of the `fabric-shim` stub for testing Nodejs chaincode.
* [hyperledger-fabric-chaincode-dev-setup](https://github.com/Kunstmaan/hyperledger-fabric-chaincode-dev-setup) ⭐ 31 | 🐛 13 | 🌐 JavaScript | 📅 2019-05-21 - Setup which makes it easy to develop Nodejs chaincode.
* [hyperledger-fabric-node-chaincode-utils](https://github.com/Kunstmaan/hyperledger-fabric-node-chaincode-utils) ⭐ 21 | 🐛 5 | 🌐 JavaScript | 📅 2018-11-26 - Utility functions for Nodejs chaincode on Hyperledger Fabric blockchain.
* [fabric-shim-types](https://github.com/wearetheledger/fabric-shim-types) ⚠️ Archived - Typescript types for the `fabric-shim` chaincode package.
* [fabric-shim-crypto-types](https://github.com/wearetheledger/fabric-shim-crypto-types) ⭐ 0 | 🐛 0 | 📅 2020-01-14 - Typescript types for the `fabric-shim-crypto` package.

### Other

* [tineola](https://github.com/tineola/tineola) ⭐ 50 | 🐛 5 | 🌐 JavaScript | 📅 2022-12-07 - Command line interface and packaged chaincode built for offensive security testing.
